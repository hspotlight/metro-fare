...
export const STATIONS: Station[] = [
    ...
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.ROYAL_FOREST_DEPARTMENT, nameEN: "Royal Forest Department", nameTH: "กรมป่าไม้", position: [13.850225,100.581762] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.KASETSART_UNIVERSITY, nameEN: "Kasetsart University", nameTH: "มหาวิทยาลัยเกษตรศาสตร์", position: [13.842299,100.577102] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.SENA_NIKHOM, nameEN: "Sena Nikhom", nameTH: "เสนานิคม", position: [13.836382,100.573640] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.RATCHAYOTHIN, nameEN: "Ratchayothin", nameTH: "รัชโยธิน", position: [13.829734,100.569724] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.PHAHON_YOTHIN_24, nameEN: "Phahon Yothin 24", nameTH: "พหลโยธิน", position: [13.824102,100.566417] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.HA_YEAK_LAT_PHRAO, nameEN: "Ha Yaek Lat Phrao", nameTH: "ห้าแยกลาดพร้าว", position: [13.816609,100.561971] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.MO_CHIT, nameEN: "Mo Chit", nameTH: "หมอชิต", position: [13.802555,100.553740] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.SAPHAN_KHWAI, nameEN: "Saphan Khwai", nameTH: "สะพานควาย", position: [13.793845,100.549729] },
    ...
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.ARI, nameEN: "Ari", nameTH: "อารีย์", position: [13.779582,100.544623] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.SANAM_PAO, nameEN: "Sanam Pao", nameTH: "สนามเป้า", position: [13.772525,100.542050] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.VICTORY_MONUMENT, nameEN: "Victory Monument", nameTH: "อนุสาวรีย์ชัยสมรภูมิ", position: [13.762761,100.537085] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.PHAYA_THAI, nameEN: "Phaya Thai", nameTH: "พญาไท", position: [13.756831,100.533736] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.RATCHATHEWI, nameEN: "Ratchathewi", nameTH: "ราชเทวี", position: [13.751830,100.531519] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.SIAM, nameEN: "Siam", nameTH: "สยาม", position: [13.745629,100.534212] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.CHIT_LOM, nameEN: "Chit Lom", nameTH: "ชิดลม", position: [13.744158,100.543022] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.PHOLEN_CHIT, nameEN: "Phloen Chit", nameTH: "เพลินจิต", position: [13.743054,100.549168] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.NANA, nameEN: "Nana", nameTH: "นานา", position: [13.740630,100.555360] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.ASOK, nameEN: "Asok", nameTH: "อโศก", position: [13.736936,100.560412] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.PHROM_PHONG, nameEN: "Phrom Phong", nameTH: "พร้อมพงษ์", position: [13.730491,100.569589] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.THONG_LO, nameEN: "Thong Lo", nameTH: "ทองหล่อ", position: [13.724252,100.578468] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.EKKAMAI, nameEN: "Ekkamai", nameTH: "เอกมัย", position: [13.719489,100.585104] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.PHRA_KHANONG, nameEN: "Phra Khanong", nameTH: "พระโขนง", position: [13.715233,100.591167] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.ON_NUT, nameEN: "On Nut", nameTH: "อ่อนนุช", position: [13.705681,100.601013] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.BANG_CHAK, nameEN: "Bang Chak", nameTH: "บางจาก", position: [13.696652,100.605295] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.PUNNAWITHI, nameEN: "Punnawithi", nameTH: "ปุณณวิถี", position: [13.689291,100.608976] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.UDOM_SUK, nameEN: "Udom Suk", nameTH: "อุดมสุข", position: [13.679884,100.609401] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.BANG_NA, nameEN: "Bang Na", nameTH: "บางนา", position: [13.668125,100.604616] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.BEARING, nameEN: "Bearing", nameTH: "แบริ่ง", position: [13.661146,100.601793] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.SAMRONG, nameEN: "Samrong", nameTH: "สำโรง", position: [13.647040,100.596021] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.PU_CHAO, nameEN: "Pu Chao", nameTH: "ปู่เจ้า", position: [13.637377,100.592020] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.CHANG_ERAWAN, nameEN: "Chang Erawan", nameTH: "ช้างเอราวัณ", position: [13.621234,100.590181] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.ROYAL_THAI_NAVAL_ACADEMY, nameEN: "Royal Thai Naval Academy", nameTH: "โรงเรียนนายเรือ", position: [13.608398,100.594883] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.PAK_NAM, nameEN: "Pak Nam", nameTH: "ปากน้ำ", position: [13.602050,100.597070] },
    { lineType: LineType.BTS_SUKHUMVIT, key: BTS_SUKHUMVIT_STATION.SRINAGARINDRA, nameEN: "Srinagarindra", nameTH: "ศรีนครินทร์", position: [13.592015,100.609034] },
